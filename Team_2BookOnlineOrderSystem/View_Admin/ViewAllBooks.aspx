<%@ Page Title="" Language="C#" MasterPageFile="~/View_Master/AdminMasterPage.Master" AutoEventWireup="true" CodeBehind="ViewAllBooks.aspx.cs" Inherits="Team_2BookOnlineOrderSystem.AdminViewAllBooks" EnableEventValidation="false"%>
     ...
     <table class="auto-style3">
         <tr>
             <td class="auto-style4">
                 <h3><asp:Label ID="Label1" runat="server" Text="Search By Category"></asp:Label></h3>
             </td>
             <td class="auto-style5">
                 <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="SqlDataSource2" DataTextField="categoryName" DataValueField="categoryName" style="margin-left: 0px">
                 </asp:DropDownList>
             ...
             <td>
                 <asp:Button ID="Button1" runat="server" Text="Search" Width="93px" Height="45px" OnClick="Button1_Click" />
             </td>
         </tr>
     </table>
